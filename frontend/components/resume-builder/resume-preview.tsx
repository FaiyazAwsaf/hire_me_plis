 ...
 * Displays a real-time preview of the resume
 * Updates instantly as the user edits
 */
export function ResumePreview({ resume }: ResumePreviewProps) {
  const previewHTML = useMemo(() => {
    return generatePreviewHTML(resume);
  }, [resume]);
        ...
        <div className="p-8 max-w-4xl mx-auto">
          ...
          {resume.personalInfo.summary && (
            <section className="mb-5">
              <h2 className="text-sm font-bold text-blue-900 uppercase border-b border-gray-300 pb-1 mb-2">
                Professional Summary
              </h2>
          ...
          {resume.experience.length > 0 && (
            <section className="mb-5">
              <h2 className="text-sm font-bold text-blue-900 uppercase border-b border-gray-300 pb-1 mb-3">
                Experience
              </h2>
...
function generatePreviewHTML(resume: Resume): string {
  return `
    <!-- This component renders the preview directly without needing to generate HTML -->
  `;
}
